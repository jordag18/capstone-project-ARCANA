        ...
        <Stack gap={3} className="p-4 mx-8 d-flex align-self-center justify-content-sm-center">
          ...
          <hr></hr>
            <Button className="p-3" variant="secondary">
              ...
              <Link href="./dashboard/projectsMenu" className="text-decoration-none text-reset">
                Manage Projects
              </Link>
            </Button>
            ...
            <Button className="p-3" variant="secondary">
              ...
              <Link href="./dashboard/syncMenu" className="text-decoration-none text-reset">
                Sync Projects
              </Link>
            </Button>
            ...
            <ListColumnsReverse size={48} className="mx-auto mb-auto p-2"/>
              <Link href="./dashboard/userActivityMenu" className="text-decoration-none text-reset">
            ...
            <Button className="p-3" variant="secondary">
              ...
              <Link href="./dashboard/systemMenu" className="text-decoration-none text-reset">
