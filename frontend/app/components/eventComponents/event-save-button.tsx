...
const SaveEventButton: React.FC<selectedEventProp> = ({ selectedEvent }) => {
  ...
  const [updatedEventData, setupdatedEventData] = useState<Event>(selectedEvent);
  ...
  return (
    <button className="btn bg-gray-400 text-white hover:bg-gray-300" onClick={handleEditEvent}>
