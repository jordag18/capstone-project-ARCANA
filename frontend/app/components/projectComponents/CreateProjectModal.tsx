...
const CreateProjectModal = () => {
    ...
    return (
        <>
            <div className="btn bg-gray-300 shadow-md hover:bg-gray-200" onClick={()=>document.getElementById('my_modal_3').showModal()}>
            ...
            <dialog id="my_modal_3" className="modal">
                <div className="modal-box">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <input type="text" className="grow" placeholder="Project Name" value={projectName} onChange={(e) => setProjectName(e.target.value)} />
                        </label>
                        <label className="input input-bordered flex items-center gap-2">
                        <input type="text" className="grow" placeholder="Location" value={projectLocation} onChange={(e) => setProjectLocation(e.target.value)} />
                        </label>
                        <div className="mb-3 d-flex space-y-4">
                            ...
                            <label className="input input-bordered flex items-center gap-2">
                                <input type="text" className="grow" placeholder="Initials" value={initials} onChange={(e) => setInitials(e.target.value)}/>
                            </label>
                        </div>
                    </div>
                    <div className="mb-3 d-flex space-y-4 space-x-2">
                        ...
                        />
                        <button className="btn" onClick={() => {handleSubmit(); document.getElementById('my_modal_3').close()}}>
                        Create Project
                        </button>
                    </div>
                </div>
