    ...
    <ListGroup style={{backgroundColor:"#e9ecef"}}>
      <ListGroup.Item style={ItemStyles}>
        <a href="./eventMenu" className="sidebar-link">
          <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-list-ul" viewBox="0 0 16 16">
      ...
      <ListGroup.Item style={ItemStyles} className="sidebar-link">
        <a href="./toaIconLibrary">
          <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-images" viewBox="0 0 16 16">
