...
const ManageUserActivity = () => {
  ...
  return (
    <div className="flex flex-auto flex-col mx-0 rounded-3xl p-3 ">
      <div className="flex flex-row items-center justify-center w-full rounded-3xl pr-5" style={{paddingBottom:15}}>
          <UiRadios size={35} style={{paddingRight:5}}/>
          <h1 className="text-3xl font-semibold pl-5" style={{paddingRight:50}}>User Activity Logger</h1>
          <button
